...
/**
 * Created by Hexa-David.Foo on 1/8/2018.
 */
...
public class PermissionsUtil {
    ...
    public PermissionsUtil(Context context, PermissionResultCallback permissionResultCallback) {
        this.context = context;
        this.current_activity = (Activity) context;
        this.permissionResultCallback = permissionResultCallback;
    }

    public void checkDefaultPermission(String dialogMessage, int requestCode) {
        ArrayList<String> permissions = new ArrayList<>();
        permissions.add(Manifest.permission.INTERNET);
        check_permission(permissions, dialogMessage, requestCode);
    }
